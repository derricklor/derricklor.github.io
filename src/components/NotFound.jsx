            ...
            <section className="bg-white dark:bg-gray-900">
                <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                    <div className="mx-auto max-w-screen-sm text-center">
                        ...
                        <Link to="/"><p className="inline-flex from-blue-300 to-purple-300 bg-gradient-to-r shadow-lg text-black dark:text-white font-medium rounded-lg text-sm px-5 py-2.5 text-center  my-4">
