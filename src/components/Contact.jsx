...
export default function Contact() {
    return (
        <div className="flexbox mx-auto flex-grow p-4 gap-6 ">
            <section className="bg-white p-6 rounded-lg shadow-md w-fit dark:bg-gray-800 dark:text-gray-200 dark:shadow-xl">
